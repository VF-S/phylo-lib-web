    ...
    <div className="wrapper main">
      <Content justify="center">
        ...
        <Row>
          ...
          <h3> Scientists often wish to infer the evolutionary history between
          ...
          and DNA analysis, the field has moved towards using DNA.

          Two species with more similar DNA are assumed to be more closely
          related. By analyzing these similarities and differences in the DNA,
          we can generate a hypothetical evolutionary tree, called a
          phylogenetic tree, that estimates what the historical evolutionary
          tree would have looked like.
          </h3>
          ...
          <h3>
            ...
            alignment, where two DNA sequences are compared. Only once
            the alignment scores of all DNA sequences with one another is known
            is it possible to determine genetic similarity and through that,
            evolutionary history. The pairwise Alignment is performed using the
            Needleman-Wunsch algorithm, a globally optimal dynamic
            programming algorithm that computes a loss for the most optimal
            alignment. Here * represents a DNA base pair match, _ a gap,
            often used if a DNA sequence is longer than the other, and |
            a mismatch.
          </h3>
          <h3>
            <b> Visualize Phylogenetic Trees: </b>
            When a phylogenetic tree has already been constructed, whether
            through this program or other commercially available software,
            it is important that the user can visualize the final alignment.
            Here we built a tokenizer, lexer, and parser to read PhyloXML,
            an extension of the popular XML format designed to encode
            phylogenetic trees.
          </h3>
          <h3>
            <b> Generate Phylogenetic Trees: </b>
            We construct phylogenetic genetic trees from DNA sequences
            encoded in a standard .FASTA format using two algorithms:
            Unweighted Pair Group Method with Arithmetic Mean (UPGMA)
            and Bayesian Inference, each with their respective tradeoffs
            regarding speed and accuracy. Each algorithm reads in the .FASTA
            files, constructs pairwise alignments, and then uses respective
            techniques to find an optimal rooted tree.

          </h3>

          <h2> Examples: </h2>
          <b>
            Examples of constructed phylogenetic trees using DNA sequences
