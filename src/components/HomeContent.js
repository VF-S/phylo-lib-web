      ...
      <Content justify="center">
        ...
        <div className="explanation">
          ...
          <Row>
            ...
            At the heart of constructing phylogenetic trees is sequence alignment, where gaps are inserted in the sequences to make them all of equal length, to get a similarity score. Only once the alignment scores of all DNA sequences with one another is known is
            it possible to determine genetic similarity and through that,
            evolutionary history.<br></br>
            One such method is the pairwise alignment, where two DNA sequences are aligned. It is performed using the
