...
function print_tree_helper(tree, tabs) {
  if (tree.tag) {
    ...
    print_inline_opt("name", tabs + 1 | 0, tree[/* name */2]);
    if (tree[/* scientific_name */0] !== "" || tree[/* id */1] !== undefined) {
      print_start_tag("taxonomy", /* [] */0, tabs + 1 | 0, true);
      if (tree[/* scientific_name */0] !== "") {
        print_inline_tag("scientific_name", tabs + 2 | 0, tree[/* scientific_name */0]);
      }
      print_inline_opt("id", tabs + 2 | 0, tree[/* id */1]);
      print_end_tag("taxonomy", tabs + 1 | 0);
    }
    return print_end_tag("clade", tabs);
  }
  print_start_tag("clade", /* [] */0, tabs, true);
  print_inline_opt("name", tabs + 1 | 0, tree[/* name */5]);
  var bootstrap = tree[/* bootstrap */2];
  ...
  if (tree[/* rank */3] !== undefined || tree[/* id */4] !== undefined) {
    print_start_tag("taxonomy", /* [] */0, tabs + 1 | 0, true);
    print_inline_opt("id", tabs + 2 | 0, tree[/* id */4]);
    print_inline_opt("rank", tabs + 2 | 0, tree[/* rank */3]);
    print_end_tag("taxonomy", tabs + 1 | 0);
  }
  var print_children = function (_children, tabs) {
    while(true) {
      ...
      print_tree_helper(children[0], tabs);
      _children = children[1];
      continue ;
    };
  };
  print_children(tree[/* children */1], tabs + 1 | 0);
  return print_end_tag("clade", tabs);
}
